module.exports = (grunt) ->
  ...
  grunt.initConfig
    ...
    buildcontrol:
      ...
      github:
        options:
          remote: 'git@github.com:getcallr/getcallr.github.io.git'
          branch: 'master'
      ...
      dist:
        files: [
          ...
          src: [
            ...
            'assets/images/og/*.{gif,jpeg,jpg,png}'
            'assets/media-kit/*'
          ]
        ]
    ...
    filerev:
      ...
      images:
        src: [
          'dist/assets/images/{,*/}*.{gif,jpeg,jpg,png}'
          '!dist/assets/images/og/*.{gif,jpeg,jpg,png}'
        ]
      scripts:
